...
f = [10 8 5 2]'; 
X = []; 
[col1 col2 col3 col4 col5 col6] = textread('./x_data', '%s%s%s%s%s%s', 'delimiter',','); 
a = [col1 col2 col3 col4 col5 col6]; 

for i = 1 : 1728 
    if strcmp(a(i,1), 'vhigh') 
        X(i,1) = f(1); 
    end 
    if strcmp(a(i,1), 'high') 
        X(i,1) = f(2); 
    end 
    if strcmp(a(i,1), 'med') 
        X(i,1) = f(3); 
    ...
    if strcmp(a(i,2), 'vhigh') 
        X(i,2) = f(1); 
    end 
    if strcmp(a(i,2), 'high') 
        X(i,2) = f(2); 
    end 
    if strcmp(a(i,2), 'med') 
        X(i,2) = f(3); 
    ...
    if strcmp(a(i,4), 'more') 
        X(i,4) = 6; 
    end 
    if strcmp(a(i,5), 'small') 
        X(i,5) = 2; 
    end 
    if strcmp(a(i,5), 'med') 
        X(i,5) = 5; 
